...
class RecoModelProcess(mp.Process):
    ...
    def run(self):
        ...
        up_interpreter = tflite.Interpreter(model_path=f"{ROOT_DIR}/models/inference/spin.tflite")
        up_interpreter.allocate_tensors()
        down_interpreter = tflite.Interpreter(model_path=f"{ROOT_DIR}/models/inference/spin.tflite")
